...
public class Cliente
{
    ...
    public void procesar(BufferedReader stdIn, BufferedReader pIn, PrintWriter pOut) throws Exception
    {
        try
        {
            ...
            // Se recibe el reto no encriptado.
            fromServer = pIn.readLine();
            System.out.println("Se recibio reto: " + fromServer);

            // Se envia reto sin encriptar.
            ...
            pOut.println(OK);
            System.out.println("Se recibió la fecha y se termino el protocolo: " + fromServer);
        }
        catch(Exception e)
        {
            pOut.println(ERROR);
